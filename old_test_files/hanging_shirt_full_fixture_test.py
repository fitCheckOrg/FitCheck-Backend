"""
Tests adding hanging-shirt LEFT's confirmed pair-companion corner
(80,456) to the exclusion fixture, alongside the hem corner already
added. Same validated pipeline, no new logic — testing whether
RIGHT now correctly falls through to its own true cuff.

Run: python hanging_shirt_full_fixture_test.py
"""
...
KNOWN_HEM_CORNERS = {
    "polo": [(378, 445), (93, 442)],
    "hanging_shirt": [(366, 458), (80, 456)],  # hem corner + LEFT's pair companion
}
