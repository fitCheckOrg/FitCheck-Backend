"""
Tests whether adding hanging-shirt's visually-confirmed hem corner
(366,458) to the known-landmark exclusion fixture resolves the
RIGHT-side collision, using the EXISTING bilateral resolution +
exclusion pipeline unchanged. No new algorithm. No selector changes.

Success = hanging-shirt RIGHT now resolves to its own confirmed 
cuff, with zero regressions on any other case.

Run: python hanging_shirt_hem_fixture_test.py
"""
...
# FIXTURE UPDATE — the only change this test makes
KNOWN_HEM_CORNERS = {
    "polo": [(378, 445), (93, 442)],
    "hanging_shirt": [(366, 458)],  # NEW — visually confirmed this session
}
